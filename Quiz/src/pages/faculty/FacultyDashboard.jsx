          ...
          {!selectedStudent ? (
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-1 gap-6">
                  ...
                  <div className="p-6 bg-white shadow-lg rounded-md border">
                    <p className="px-2 py-1 font-semibold">
                      For Adding Updating and Deleting Student !!
                    </p>
                    <Addstudent />
                  </div>
                </div>
            ...
            >
              <div className="space-y-3">
                ...
                {/* CreateQuiz placed below student details */}
                <div className="mt-8 p-6 bg-white shadow-lg rounded-md border">
                  <CreateQuiz
                    key={location.key}
                    facultyDetails={facultyDetails}
                  />
...
//       {/* Sidebar */}
//       {sidebarOpen && (
//         <aside className="h-screen w-1/5 bg-[#6a4baf] text-white p-6 shadow-xl fixed z-20 flex flex-col justify-between">
//           <div>
//             <h2 className="text-xl font-bold mb-6 border-b border-purple-300 pb-2">
//               Faculty Profile
//             </h2>
//             <div className="space-y-3 text-sm bg-[#7f62cc] p-4 rounded-md shadow-inner">
//               <div>
//                 <span className="font-semibold">Name:</span> {facultyDetails.name}
//               </div>
//               <div>
...
//           <button
//             onClick={() => navigate("/")}
//             className="bg-[#4e3a8c] w-full py-2 rounded-md hover:bg-[#8e6ec0] transition text-sm font-medium shadow-md"
//           >
//             Logout
//           </button>
//         </aside>
...
//           {!selectedStudent ? (
//             <div>
//               <h2 className="text-2xl font-semibold mt-4 text-[#4e3a8c]">
//                 Select a Class
//               </h2>
//               <div className="flex space-x-4 mt-4">
//                 {[1, 2, 3, 4].map((year) => (
//                   <button
//                     key={year}
//                     className="px-5 py-2 bg-[#6a4baf] text-white rounded-md hover:bg-[#8e6ec0] transition duration-200 shadow-md"
//                     onClick={() => setSelectedClass(year)}
//                   >
//                     {year} Year
//                   </button>
...
//               {!selectedClass && (
//                 <div className="mt-8 grid grid-cols-1 md:grid-cols-1 gap-6">
//                   <div className="p-6 bg-white shadow-lg rounded-md border border-purple-200">
//                     <CreateQuiz
//                       key={location.key}
//                       facultyDetails={facultyDetails}
//                     />
...
//               {selectedClass && (
//                 <>
//                   <h3 className="text-xl font-semibold mt-8 text-[#4e3a8c]">
//                     {selectedClass} Year Students
//                   </h3>
//                   <input
//                     type="text"
...
//                     value={searchTerm}
//                     onChange={(e) => setSearchTerm(e.target.value)}
//                     className="mt-4 border border-purple-300 p-3 w-full rounded-md shadow-sm focus:ring focus:ring-purple-400 focus:border-purple-400"
//                   />

//                   <table className="mt-6 border-collapse border border-purple-300 w-full text-sm shadow-md rounded-md overflow-hidden">
//                     <thead>
//                       <tr className="bg-[#6a4baf] text-white">
//                         <th className="border border-purple-300 p-3">Sr. No</th>
//                         <th className="border border-purple-300 p-3">UID</th>
...
//                           <td
//                             colSpan="3"
//                             className="text-center border border-purple-300 p-3"
//                           >
//                             No students found.
//                           </td>
//                         </tr>
...
//               <div className="space-y-3">
//                 <div className="flex flex-row justify-between items-center">
//                   <h3 className="text-2xl font-bold border-b pb-2 mb-4 text-[#4e3a8c]">
//                     {selectedStudent.name}
//                   </h3>
//                   <button
//                     onClick={() => setSelectedStudent(null)}
//                     className="flex items-center py-2 px-4 bg-purple-100 text-purple-800 rounded-lg hover:bg-purple-200 transition"
//                   >
//                     <FaArrowLeft className="mr-2" />
//                     Back
//                   </button>
...
//                 <h4 className="text-lg font-semibold mt-6 border-b pb-1 text-[#4e3a8c]">
//                   Quiz Submissions
//                 </h4>
//                 {submissions.length > 0 ? (
//                   <div className="grid md:grid-cols-2 gap-4 mt-3">
...
//                       <div
//                         key={sub._id}
//                         className="p-4 border shadow-sm bg-purple-50 rounded-md hover:shadow-md transition"
//                       >
//                         <h5 className="font-semibold text-[#6a4baf]">
//                           {sub.quizId?.title || "Untitled Quiz"}
//                         </h5>
...
//                             })
//                           }
//                           className="mt-3 bg-[#6a4baf] text-white px-4 py-1 rounded-md hover:bg-[#8e6ec0] transition"
//                         >
//                           See Result
//                         </button>
//                       </div>
